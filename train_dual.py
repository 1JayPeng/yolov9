...
def parse_opt(known=False):
    ...
    parser.add_argument('--cfg', type=str, default=r'models\detect\yolov9-c.yaml', help='model.yaml path')
    parser.add_argument('--data', type=str, default=ROOT / r'data/Skechers.yaml', help='dataset.yaml path')
